...
For ease of editing and review, the original CDB specification has been separated into 12 Volumes and a schema repository.
...
* Volume 13: OGC CDB Optional Extension for Structuring a CDB compliant GeoPackage (Normative).
