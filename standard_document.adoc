...
|Submission Date: 2023-XX-XX
|Approval Date:   2023-XX-XX
|Publication Date:   2023-XX-XX
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/cdb-radar/1.3
|Internal reference number of this OGC(R) document:    16-004r6
|Version: 1.3
|Category: OGC(R) Best Practice
|Editor:   Carl Reed, David Graham
|===
