:Title: Volume 5: OGC CDB Radar Cross Section (RCS) Models (Best Practice)
:titletext: Volume 5: OGC CDB Radar Cross Section (RCS) Models (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|===
|*Copyright notice*
|Copyright (C) 2018, 2019, 2020 Open Geospatial Consortium
